...
export const WORKSPACES_MESSAGES = {
  ...
  WORKSPACE_VISIBILITY_MUST_BE_PUBLIC_OR_PRIVATE: 'Workspace visibility must be "Public" or "Private"',
...
export const BOARDS_MESSAGES = {
  ...
  BOARD_VISIBILITY_MUST_BE_PUBLIC_OR_PRIVATE: 'Board visibility must be "Public" or "Private"',
  ...
  ARCHIVE_BOARD_SUCCESS: 'Board archived successfully',
  REOPEN_BOARD_SUCCESS: 'Board reopened successfully',
  CANNOT_REMOVE_LAST_BOARD_ADMIN: 'Cannot remove the last admin from board. At least one admin must remain.',
  ...
  BOARD_IS_NOT_CLOSED: 'Board is not closed',
...
export const CARDS_MESSAGES = {
  ...
  ARCHIVE_CARD_SUCCESS: 'Card archived successfully',
  REOPEN_CARD_SUCCESS: 'Card reopened successfully',
  ...
  CARD_IS_NOT_ARCHIVED: 'Card is not archived',
  CARD_IS_ARCHIVED_REOPEN_REQUIRED: 'Card is archived. Please reopen the card before making changes',
  CARD_MUST_BE_ARCHIVED_BEFORE_DELETION: 'Card must be archived before it can be deleted',
